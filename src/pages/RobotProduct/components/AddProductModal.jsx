  ...
  return (
    <CSSTransition in={showModal} timeout={300} classNames="fade" unmountOnExit>
      ...
      >
        <div
          data-dialog="modal"
          className="relative m-4 p-4 w-full max-w-md sm:w-3/5 lg:w-2/5 min-w-[70%] sm:min-w-[60%] lg:min-w-[60%] xl:min-w-[50%] 2xl:min-w-[30%] rounded-lg bg-white shadow-lg"
        >
          <div className="flex shrink-0 items-center pb-4 text-xl font-medium text-slate-800">ثبت محصول جدید</div>
